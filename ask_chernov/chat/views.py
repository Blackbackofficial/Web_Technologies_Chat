...
def login(request):
    return render(request, 'chat/templates/chat/login.html')


def signup(request):
    return render(request, 'chat/templates/chat/signup.html')
...
def question(request, quest_num=1):
    ...
    return render(request, 'chat/templates/chat/question.html',
...
def questions_tag(request, tag):
    ...
    return render(request, "chat/templates/chat/tag.html", {'posts': page.object_list, 'avatar': avatar(request),
...
def make_login(request):
    ...
    if request.method == "POST":
        ...
        return render(request, 'chat/templates/chat/login.html', {'form': form})
    return render(request, 'chat/templates/chat/login.html', {'form': form})
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            try:
                ...
                alert = False
                return render(request, 'chat/templates/chat/signup.html', {'form': form, 'alert': alert})
        alert = True
        return render(request, 'chat/templates/chat/signup.html', {'form': form, 'alert': alert})
...
def ask_quest(request):
    ...
    if request.method == "POST":
        ...
        return render(request, 'chat/templates/chat/ask.html', {'form': form, 'avatar': avatar(request)})
    form = AskForm()
    return render(request, 'chat/templates/chat/ask.html', {'form': form, 'avatar': avatar(request)})
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                if user is not None:
                    auth.login(request, user)
            alert = True
            return render(request, 'chat/templates/chat/settings.html', {'form': form, 'avatar': avatar(request), 'alert': alert})
        # auto filed
